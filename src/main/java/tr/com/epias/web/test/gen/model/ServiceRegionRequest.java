...
public class ServiceRegionRequest   {
  ...
  @SerializedName("body")
  private RegionRequest body = null;
  ...
  public RegionRequest getBody() {
    return body;
  }
  public void setBody(RegionRequest body) {
    this.body = body;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServiceRegionRequest serviceRegionRequest = (ServiceRegionRequest) o;
    return Objects.equals(this.header, serviceRegionRequest.header) &&
        Objects.equals(this.body, serviceRegionRequest.body);
  }
